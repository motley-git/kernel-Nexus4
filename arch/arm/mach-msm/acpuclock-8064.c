...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	[0]  = { {  334000, PLL_8, 0, 2, 0x00 }, 1000000, 1000000, 1 },
	[1]  = { {  384000, HFPLL, 2, 0, 0x20 }, 1050000, 1050000, 2 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	{ 1, {   334000, PLL_8, 0, 2, 0x00 }, L2(0),   900000 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(6),   950000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {   334000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(6),   900000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {   334000, PLL_8, 0, 2, 0x00 }, L2(0),   825000 },
	{ 0, {   384000, HFPLL, 2, 0, 0x20 }, L2(6),   850000 },
