...
static char p_gamma_r_setting[10] = {0xD0, 84, 42, 118, 0, 22, 6, 74, 48, 2};
static char n_gamma_r_setting[10] = {0xD1, 84, 42, 118, 0, 22, 6, 74, 48, 2};
static char p_gamma_g_setting[10] = {0xD2, 84, 42, 118, 0, 22, 6, 75, 48, 2};
static char n_gamma_g_setting[10] = {0xD3, 84, 42, 118, 0, 22, 6, 75, 48, 2};
static char p_gamma_b_setting[10] = {0xD4, 84, 42, 118, 0, 22, 6, 75, 48, 2};
static char n_gamma_b_setting[10] = {0xD5, 84, 42, 118, 0, 22, 6, 75, 48, 2};
